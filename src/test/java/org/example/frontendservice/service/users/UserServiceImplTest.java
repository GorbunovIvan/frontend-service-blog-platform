...
public class UserServiceImplTest {
    ...
    public void setUp() {
        ...
        if (openingOfMocks == null) {
            ...
            Mockito.reset(userServiceDetails, modelsBinder, usersUtil, passwordEncoder);
        }
    ...
    public void testGetAll() {
        ...
        verify(modelsBinder, times(1)).addDependencyFieldsToUsers(anyList());
    }
    ...
    public void testGetById() {
        ...
        verify(modelsBinder, times(users.size())).addDependencyFieldsToUser(any(User.class));
    }
    ...
    public void testGetById_NotFound() {
        ...
        verify(modelsBinder, times(1)).addDependencyFieldsToUser(any());
    }
    ...
    public void testCreate() {
        ...
        verify(modelsBinder, times(1)).addDependencyFieldsToUser(any(User.class));
    }
    ...
    public void testUpdate_NotFound() {
        ...
        verify(modelsBinder, never()).addDependencyFieldsToUser(any(User.class));
