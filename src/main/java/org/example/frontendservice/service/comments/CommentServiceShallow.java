...
import org.example.frontendservice.utils.modelsbinders.comments.ModelsBinderForCommentsShallow;
...
@Log4j2
public class CommentServiceShallow implements CommentService {

    private final CommentServiceDetails commentServiceDetails;
    private final CommentServiceDummy commentServiceDummy;

    private final ModelsBinderForCommentsShallow modelsBinder;
